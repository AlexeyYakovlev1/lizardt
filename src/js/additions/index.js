...
var allMethods = __assign(__assign(__assign(__assign(__assign(__assign(__assign({}, array_1.default), dom_1.default), general_1.default), object_1.default), func_1.default), number_1.default), string_1.default);
exports.default = {
    additions: {},
