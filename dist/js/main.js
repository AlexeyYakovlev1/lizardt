...
/***/ "./src/js/categories/object.js":
/*!*************************************!*\
  !*** ./src/js/categories/object.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar objectCategory = {\n    isObject: function (item, callback) {\n        if ((item\n            && !Array.isArray(item)\n            && item !== null && typeof item === 'object'\n            && !(item instanceof Element)\n            && Object.create(item))\n            || item === JSON.stringify({})) {\n            if (callback instanceof Function) {\n                return callback();\n            }\n            return true;\n        }\n        return false;\n    }\n};\nexports[\"default\"] = objectCategory;\n\n\n//# sourceURL=webpack://dom_library/./src/js/categories/object.js?");
...
/******/ 	__webpack_require__("./src/js/categories/object.js");
